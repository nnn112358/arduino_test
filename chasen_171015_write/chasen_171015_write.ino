...
void loop() {
  ...
  if (pc_input_char != -1 ) {
    ...
    switch (pc_input_char) {
      case '1':
        spcon_chasen.write(180);
        break;
      case '2':
        spcon_chasen.write(0);
        break;
      case '3':
        spcon_chasen_lift.write(180);
        break;
      case '4':
        spcon_chasen_lift.write(0);
        break;
      case '5':
        spcon_turntable.write(180);
        break;
      case '6':
        spcon_turntable.write(0);
        break;
      case '7':
        servo_hisyaku.write(180);
        break;
      case '8':
        servo_hisyaku.write(0);
        break;
      case '9':
      ...
      case 'w':
        ...
        break;
      case 'e':
        servo_arm3.write(180);
        break;
      case 'r':
        servo_arm3.write(0);
        break;
      case 't':
        servo_arm4.write(180);
        break;
      case 'y':
        servo_arm4.write(0);
        break;
